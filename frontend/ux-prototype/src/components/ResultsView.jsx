    ...
    <div className="p-8 space-y-8 animate-in zoom-in-95 duration-500">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white tracking-tight">
              Análisis: Reporte_Anual_2025.pdf
            </h1>
            <p className="text-slate-500 text-sm font-medium">
              Procesado en Enclave Local • ID: #COG-9921
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          ...
          <div
            className={`grid grid-cols-1 md:grid-cols-2 gap-6 transition-all duration-700 ${showItems ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
          >
          ...
          <div
            className={`glass-morphism rounded-3xl p-8 transition-all duration-1000 delay-300 ${showItems ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
          >
            ...
            <div className="space-y-4">
              {[
                {
                  text: "La arquitectura local garantiza que los datos no abandonen el perímetro del enclave físico.",
                  cat: "Seguridad / Soberanía",
                  score: 0.98,
                },
                {
                  text: "Se recomienda la migración de los microservicios de análisis a instancias con mayor GPU compartida.",
                  cat: "Operaciones",
                  score: 0.85,
                },
                {
                  text: "Los plazos de entrega se han visto afectados por la escasez de componentes semiconductores.",
                  cat: "Logística",
                  score: 0.72,
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="group p-5 rounded-2xl bg-slate-900/40 hover:bg-slate-800 transition-all border border-slate-800/50 hover:border-blue-500/30"
                >
                  <p className="text-slate-300 italic mb-4 text-base font-medium">
                    "{item.text}"
                  </p>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-32 h-2 bg-slate-800 rounded-full overflow-hidden">
                        <div
                          className="h-full bg-gradient-to-r from-blue-600 to-indigo-400 transition-all duration-1000 delay-500"
                          style={{
                            width: showItems ? `${item.score * 100}%` : "0%",
                          }}
                        ></div>
                      </div>
        ...
        <div className="space-y-8">
          ...
          <div
            className={`glass-morphism rounded-3xl p-6 transition-all duration-700 delay-500 ${showItems ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}
          >
            ...
            <div className="space-y-6">
              <div>
                <span className="text-xs font-bold text-slate-600 uppercase tracking-widest block mb-3">
                  Organizaciones
                </span>
                <div className="flex flex-wrap gap-2">
                  <span className="px-4 py-2 rounded-xl bg-indigo-500/10 text-indigo-400 text-sm font-bold border border-indigo-500/10">
                    Atlantyqa Labs
                  </span>
                  <span className="px-4 py-2 rounded-xl bg-indigo-500/10 text-indigo-400 text-sm font-bold border border-indigo-500/10">
                    EU Sovereign Fund
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-4 py-2 rounded-xl bg-green-500/10 text-green-400 text-sm font-bold border border-green-500/10">
                    Final Q4 2024
                  </span>
                  <span className="px-4 py-2 rounded-xl bg-green-500/10 text-green-400 text-sm font-bold border border-green-500/10">
                    Marzo 15, 2025
          ...
          <div
            className={`glass-morphism rounded-3xl p-6 transition-all duration-700 delay-700 ${showItems ? "opacity-100 translate-x-0" : "opacity-0 translate-x-4"}`}
          >
            ...
            <div className="relative border-l-2 border-slate-800 ml-2 pl-6 space-y-8">
              <div className="relative">
                ...
                <p className="text-xs text-slate-500 mt-1 font-medium">
                  Sincronización completa con enclave local.
                </p>
              </div>
              <div className="relative">
                ...
                <p className="text-xs text-slate-400 mt-1 font-medium">
                  Generando Pull Request en rama efímera...
                </p>
              </div>
            </div>
          </div>
